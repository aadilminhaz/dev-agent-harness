...
echo "    • start-story        — Start work on a ticket"
echo "    • finish-story       — Finish work & create MR/PR"
echo "    • review-mr          — Automated code review"
echo ""
echo -e "  ${BOLD}Usage:${RESET}"
echo "    'start story on <service>, ticket <ID>, feature'"
echo "    'finish story'"
echo "    'review the MR for this branch'"
echo ""
